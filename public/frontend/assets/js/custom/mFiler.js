...
(function ($) {
                        ...
                        if (s.get(0)
                            ...
                            if (n.changeInput) {
                                switch (typeof n.changeInput) {
                                    case "boolean":
                                        o = $('<div ondragover="event.preventDefault()" ondragenter="event.preventDefault()" ondrop="mFilerDrag($(this))" class="jFiler-input"><div class="jFiler-input-caption"><span>' + n.captions.feedback + '</span></div><div class="jFiler-input-button">' + n.captions.button + '</div></div>"');
                                        break;
                                    case "string":
                                    case "object":
                                        o = $(n.changeInput);
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            button: "Drop Documents",
            feedback: "Choose Documents",
            feedback2: "files were chosen",
            drop: "Drop file here to Upload",
            removeConfirmation: "Do you want to remove this file?",
            errors: {
